...
function Button({ settings, text }: ButtonProps) {
	return (
		<>
			<button
				className={` border-1 px-10 py-3 m-3 rounded-xl  cursor-pointer text-white transition ease-out  hover:bg-sluggreen-300   hover:border-sluggreen-100 hover:shadow-lg   ${
