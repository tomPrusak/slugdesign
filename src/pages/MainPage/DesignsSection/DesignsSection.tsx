...
function DesignsSection() {
	...
	return (
		<section className="relative">
			...
			<div className="bg-gradient-to-t from-[#11708a] to-[#00a0b7] flex">
				<div className="column w-screen">
					<section className="justify-start w-200 text-center">
						...
						<p>
							At SlugDesign, we always take care to understand the business we
							are representing, and we work closely with our clients to Build
							websites to exact specifications. At SlugDesign will craft a
							contemporary and unique website just for you.
						</p>
